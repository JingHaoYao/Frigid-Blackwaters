...
public class PlantMortarProjectile : PlayerProjectile
{
    ...
    [SerializeField] GameObject ailaPlantToSpawn;
    ...
    private void Update()
    {
        ...
        if (currentTime >= totalTime)
        {
            ...
            if(ailaPlantToSpawn != null)
            {
                Instantiate(ailaPlantToSpawn, transform.position, Quaternion.identity);
            }
        }
