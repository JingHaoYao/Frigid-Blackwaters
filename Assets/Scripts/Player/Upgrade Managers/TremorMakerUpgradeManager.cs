...
public class TremorMakerUpgradeManager : WeaponFireTemplate
{
    ...
    void applyUpgrades()
    {
        ...
        else if (PlayerUpgrades.tremorMakerUpgrades.Count <= 2)
        {
    ...
    void Start()
    {
        prevNumberUpgrades = PlayerUpgrades.tremorMakerUpgrades.Count;
    ...
    void Update()
    {
        if (prevNumberUpgrades != PlayerUpgrades.tremorMakerUpgrades.Count)
        {
            prevNumberUpgrades = PlayerUpgrades.tremorMakerUpgrades.Count;
            applyUpgrades();
            weaponScript.setTemplate();
