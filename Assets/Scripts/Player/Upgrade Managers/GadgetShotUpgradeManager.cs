...
public class GadgetShotUpgradeManager : WeaponFireTemplate
{
    ...
    void applyUpgrades()
    {
        if (PlayerUpgrades.gadgetShotUpgrades.Count >= 3)
        {
            weaponTemplate.coolDownTime = Mathf.Round(origCoolDownTime * 0.85f * 100f) / 100f;
        }
        else if (PlayerUpgrades.gadgetShotUpgrades.Count <= 2)
        {
    ...
    void Start()
    {
        prevNumberUpgrades = PlayerUpgrades.gadgetShotUpgrades.Count;
    ...
    void Update()
    {
        if (prevNumberUpgrades != PlayerUpgrades.gadgetShotUpgrades.Count)
        {
            prevNumberUpgrades = PlayerUpgrades.gadgetShotUpgrades.Count;
            applyUpgrades();
            weaponScript.setTemplate();
