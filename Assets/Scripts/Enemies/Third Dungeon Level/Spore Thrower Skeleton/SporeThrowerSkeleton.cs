...
public class SporeThrowerSkeleton : Enemy
{
    ...
    IEnumerator launchBall()
    {
        ...
        animator.SetTrigger("Attack" + currView);
    ...
    void spawnBomb()
    {
        GameObject thornBallInstant = Instantiate(thornBall, transform.position + new Vector3(0, 0.7f), Quaternion.identity);
        thornBallInstant.GetComponent<SporeBall>().targetLocation = PlayerProperties.playerShipPosition;
