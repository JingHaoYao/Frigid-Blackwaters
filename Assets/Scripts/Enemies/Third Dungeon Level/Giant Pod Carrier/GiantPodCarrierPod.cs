...
public class GiantPodCarrierPod : MonoBehaviour
{
    ...
    public GameObject smallPodJumper;
    ...
    private void Update()
    {
        ...
        if (currentTime >= totalTime)
        {
            ...
            GameObject podInstant = Instantiate(smallPodJumper, transform.position, Quaternion.identity);
            EnemyPool.addEnemy(podInstant.GetComponent<Enemy>());
        }
