...
public class PyroettePyrotheumProjectile : MonoBehaviour
{
    ...
    public void Initialize(Vector3 center, GameObject instantiater)
    {
        this.center = center;
    ...
    private void Update()
    {
        if (impacted == false)
        {
            ...
            transform.rotation = Quaternion.Euler(0, 0, Mathf.Atan2(directionVector.y, directionVector.x) * Mathf.Rad2Deg + 90);
