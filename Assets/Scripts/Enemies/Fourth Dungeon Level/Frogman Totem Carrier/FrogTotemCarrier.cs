...
public class FrogTotemCarrier : Enemy
{
    ...
    int mirror = 1;
    Camera mainCamera;
    [SerializeField] LightAuraController lightController;
    ...
    public override void statusUpdated(EnemyStatusEffect newStatus)
    {
        ...
        {
            lightController.fadeInLights(0.3f);
        }
    }
    ...
    public override void statusRemoved(EnemyStatusEffect removedStatus)
    {
        ...
        {
            lightController.fadeOutLights(0.3f);
        }
    }
    ...
    void pickView(float angleOrientation)
    {
        ...
        if(whatView <= 2)
        {
            lightController.SetRenderer(this.spriteRenderer.sortingOrder + 3);
        }
        else
        {
            lightController.SetRenderer(this.spriteRenderer.sortingOrder - 3);
